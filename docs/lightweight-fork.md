# SmolVLA-Lite — 경량화 포크 상세

이 저장소에 들어 있는 SmolVLA 경량화 포크의 운영 문서입니다. 재학습 없이 사전학습 체크포인트
호환을 유지한 채 chunk 지연을 2.4× 줄입니다. 원본:
[`huggingface/lerobot`](https://github.com/huggingface/lerobot) v0.5.1 (`19c6adef`)
`src/lerobot/policies/smolvla/`.

프로젝트 개요와 논문 내용은 [`README.md`](../README.md)를 보세요.
...
- PyPI 표준 PyTorch는 sm_87을 충분히 지원하지 않습니다 — 위 [README의 실험 설정](../README.md#실험-설정) 참조.
...
[README의 제안 방법](../README.md#제안-방법) 참조.
